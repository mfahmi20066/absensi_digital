        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-100 flex flex-wrap items-center justify-between gap-3">
                <div class="flex items-center gap-2.5">
                    ...
                    <div>
                        <h2 class="font-bold text-gray-800">Detail Pengajuan Saya</h2>
                        <p class="text-xs text-gray-500">Diajukan {{ $req->created_at->translatedFormat('d M Y, H:i') }}</p>
                    </div>
                </div>
                <a href="{{ route('karyawan.cuti.index') }}" class="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-gray-100 hover:bg-gray-200 text-gray-700 text-sm font-semibold transition">
                    ...
                    <div class="space-y-0">
                        <div class="flex gap-3">
                            ...
                            <div class="pb-4">
                                ...
                                <div class="text-xs text-gray-500">{{ $req->created_at->translatedFormat('d M Y, H:i') }}</div>
                            </div>
                        </div>
